...
REST_FRAMEWORK = {
    ...
    #     'rest_framework.renderers.JSONRenderer',  # ✅ Sirf JSON render karega
    # ),
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': 'your_secret_key_here',  # ❗ Replace this with a secure key
}
...
# admin panal username:admin,password:admin123